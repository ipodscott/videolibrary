<?php get_header(); ?>
 ...
 <?php 
		...
		<div class="menu-title"> <div><a href="/"><span class="material-icons">home</span></a><span class="show-page-menu"><span class="material-icons">apps</span></span></div><div><?php the_title();?></div><div><span class="close-menu" style="display: none;"><span class="material-icons">close</span></span></div></div>
			
			<div class="link-group">
				<div class="acc-head link-group-title  active ">About the Video			
