...
<?php foreach( $posts as $post): // variable must be called $post (IMPORTANT) ?>
	...
	<?php }else if ($selectVid == "mp4_upload"){ ?>
		...
		<div class="video-link <?php the_field('resolution');?> mp4-link" mp4Url="<?php the_field('mp4_upload');?>"><i class="material-icons">video_label</i> <?php the_field('video_title');?></div>
